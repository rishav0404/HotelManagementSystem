...
public class Reception extends JFrame implements ActionListener{
    ...
    Reception()
    {
        ...
        b5= new JButton("All Customer Info");
        ...
        ImageIcon i1= new ImageIcon(ClassLoader.getSystemResource("hotel/mangementt/system/icons/fourth.jpg"));
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==b1){
            ...
            new CustomerInfo().setAlwaysOnTop(true);
            this.setVisible(false);
